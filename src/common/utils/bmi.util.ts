/**
 * It calculates the BMI and returns the value and status according to the WHO classification.
 *
 * @param heightCm Height in centimeters
 * @param weightKg Weight in kilograms
 * @returns Object containing { bmi, status }
 */

export function calculateBMI(heightCm: number, weightKg: number): { bmi: number; status: string } {
